...
'pk.eyJ1Ijoid2ltbWlueSIsImEiOiJjbWt5bHVvdDgwOG1vM2ZteDl5eGZ0am84In0.QEg_HWjaY1suD_U9S0QnCQ';
...
map.on('load', () => { //simplifying the function statement: arrow with brackets to define a function
    ...
    map.on('click', 'earthquakes-point', (event) => {
        new mapboxgl.Popup()
            ...
            .setHTML(`<strong>Magnitude:</strong> ${event.features[0].properties.counts}`)
            .addTo(map);
    });
});
// create legend
